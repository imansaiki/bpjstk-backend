...
public class PembinaSpecification implements Specification<Pembina> {

    private QueryBuilderCriteria criteria;

    public PembinaSpecification(String field, String operator, String value){
    ...
    @Override
    public Predicate toPredicate(Root<Pembina> root, CriteriaQuery<?> criteriaQuery, CriteriaBuilder criteriaBuilder) {
        try {
